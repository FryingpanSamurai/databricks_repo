...
# MAGIC %sql
# MAGIC USE CATALOG demo_workspace

# COMMAND ----------

data_source_uri = "s3://dalhussein-books/DEA-Book/datasets/school/v1/"
dataset_school = 'abfss://unity-catalog-storage@dbstorageqh3nvwxzzfwa6.dfs.core.windows.net/7405605315193329/mnt/DE-Associate-Book/datasets/school'
checkpoint_path = 'abfss://unity-catalog-storage@dbstorageqh3nvwxzzfwa6.dfs.core.windows.net/7405605315193329/mnt/DEA-Book/checkpoints'
dlt_path = 'abfss://unity-catalog-storage@dbstorageqh3nvwxzzfwa6.dfs.core.windows.net/7405605315193329/mnt/DEA-Book/dlt'
